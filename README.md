...
> 
> Tổng hợp từ hệ thống nghiên cứu của Henry Phạm[![License: CC BY-SA 4.0](https://img.shields.io/badge/License-CC%20BY--SA%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-sa/4.0/)
...
Tennis WIKI là một **wiki tĩnh (static wiki)** được xây dựng từ hơn 350 bài viết chuyên sâu về quần vợt hiện đại, được dịch và biên soạn từ kho tài liệu cá nhân của **Henry Phạm**.
