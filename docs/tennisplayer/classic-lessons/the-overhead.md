...
**[[The drop-step and powerful and quick crossover steps are the key to getting back for difficult lobs.]{.underline}]{.mark}** Players can also side shuffle backwards for easier lobs within range.
