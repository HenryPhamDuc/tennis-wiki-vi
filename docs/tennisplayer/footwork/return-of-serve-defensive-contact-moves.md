---
title: "Return of Serve - Defensive Contact Moves"
section: "Footwork"
...
In this series we are looking at the Contact Moves to develop world class footwork on the return of serve. In the last article, we looked at the patterns for aggressive returns. ([**[Click Here]{.underline}**](https://www.tennisplayer.net/members/footwork/david_bailey/contact_moves_return/aggressive_return/).) Now let\'s turn to defensive returns.
