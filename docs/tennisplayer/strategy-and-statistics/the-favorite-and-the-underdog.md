---
title: "The Favorite and the Underdog"
...
Let's look at what happened from another, related angle.  Elliot Teltscher has identified a basic attribute in the games of all tennis players, which is their "shot tolerance."  ([[Click Here]{.underline}].)  Shot tolerance is the average number of balls a player is physically, mentally and emotionally able to hit in a given point. When players reach the limit of their shot tolerance they are much more likely to either abruptly go for a winner, regardless of their position in the point, or to try a low percentage shot.
