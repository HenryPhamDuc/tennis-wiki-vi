...
**What is the most common number of hits in pro points? Is that the same as average rally length?**

In the first article I gave an overview of what I called the new magic numbers in tennis. Compiled from all the levels of tennis, these numbers included average rally length, the dominant role of errors in determining outcome, and the surprising effectiveness of net approaches. ([Click Here](the-new-magic-numbers.md).)
...
**In women\'s tennis the number of points decided by 4 hits or less is even higher than the men.**
...
**What percentage of balls you hit in practice are serves---especially hit to spots?**
...
**[[The implication of the evidence is shocking. The evidence clearly shows that our time on the practice court is misguide and not nearly as effective as it needs to be.]{.underline}]{.mark}** **[[The problem is we have no balance. We grind and slap groundstrokes around for hours, get exhausted and congratulate ourselves on how hard we are working.]{.mark}]{.underline}**

**[[Meanwhile we don\'t spend anywhere near enough time on the serve and return, the two shots that determine the biggest percentage of points.]{.underline}]{.mark}** **[[The shared delusion is that groundstroke rallies are what matter the most. They don\'t.]{.mark}]{.underline}**
