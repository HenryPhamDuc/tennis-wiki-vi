---
title: "Using Statistics to Improve Results"
...
**Racket Stats provides the numbers to optimize performance. ([Click Here](https://racketstats.com/).)**
...
In the first article in this series we discussed another metric developed by Bill Jacobson, called the Aggressive Margin. ([Click Here](https://www.tennisplayer.net/members/strategy/andy_durham/using_statistics_in_coaching/part_1/).) The difference compared to our Win/Error ratios is that the Aggressive Margin distinguishes between forced and unforced errors.
