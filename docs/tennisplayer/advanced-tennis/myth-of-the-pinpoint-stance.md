---
title: "Myth of the Pinpoint Stance"
...
**[The theory is that by bringing the back foot up, players can actually push off with both legs, compared to the Platform where the push comes from the front leg only.]{.mark}**

**[In theory using both legs increases the positive benefits of the deep knee bend by increasing the transfer of energy as the legs uncoil.]{.mark}**
...
Evaluating the benefits of the two stances and the role of the legs in the serve is, however, a complex task. First, we can\'t point to examples of pro players going back and forth between the two stances so we can readily compare results.
...
Advanced Tennis studies comparing Pete Sampras to Rusedski show that both players make contact at virtually identical heights - on average, 9\' 5\" above the court surface.
...
You can\'t do it! What you will find is that if you really push off with the back leg, you\'ll immediately leave the court.
...
As with Hewitt, you see Phillippoussis come up on the back toes. This makes it difficult or impossible to push. And, like Hewitt, you also see the telltale rotation forward of the back leg as the torso rotates.
...
And this in fact is what Sampras does. He rotates his torso onto the line of this stance, turning his back away from the net. As I have written [(see Sampras Body Rotation)](https://www.tennisplayer.net/members/worldclassstrokes/john_yandell/sampras_serve/sampras_serve_radical_torso_rotation_part5_images/sampras_serve_radical_torso_rotation_part5.html), this allows Pete to rotate his body 120 degrees or more back into the motion, a technique first developed by the great John McEnroe [(see the McEnroe serve)](https://www.tennisplayer.net/members/worldclassstrokes/john_yandell/mac_serve_images/mac_serve.html).
...
So if the Pinpoint is irrelevant or even a negative, then why do so many good players use it? That\'s a fascinating question with no clear answer. Perhaps it\'s a hold over from the old days before the change in the rules that allowed the players to leave the court with both feet. [(see Myth of the Back Foot)](https://www.tennisplayer.net/members/avancedtennis/john_yandell/the_myth/the_myth_of_the_back_foot_images/the_myth_of_the_back_foot.html).

I think it\'s also possible that the wide spread use of the Pinpoint motion in the modern game is due in part to the influence of two great Czech players who dominated the game in the 1980s: Martina Navratilova and Ivan Lendl. [(Click here to study Lendl\'s serve in the Stroke Archive)](https://www.tennisplayer.net/members/strokearchive/strokearchive.html).
...
Interestingly, I had the chance to film Martina at Indian Wells when she emerged from retirement this year to play doubles. To my surprise, she no longer drags the back foot up at all and uses a classic Platform Stance!
...
***[[But not everything every pro player does is necessarily a bio-mechanical advantage or a good thing to copy. This is a meta-question that coaches need to address in studying pro players: what is core, what is incidental, and what is, possibly, counter-productive.]{.underline}]{.mark}***
...
My conclusion? ***[[The real leg action on the serve comes from the uncoiling of the front leg. The back leg is mostly along for the ride (except for the kick back motion as you leave the court).]{.mark}]{.underline}*** I\'ve seen it in pro players, and I\'ve proved it to myself and on my teaching court. Develop it, perfect it, and more than likely you\'ll serve much better as well.
