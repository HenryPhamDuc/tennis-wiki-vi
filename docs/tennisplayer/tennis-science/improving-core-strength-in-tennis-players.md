---
title: "Improving Core Strength in Tennis Players"
...
**[[First, let\'s define the trunk. The trunk includes the thorax (chest), rib cage, abdomen, spine, and shoulder and pelvic girdle.]{.underline}]{.mark}** The trunk acts as a base for all movement. Looking at a physiological cross-section of the muscles that comprise the trunk area, the potential for the development of size is not obvious. **[[These muscles are basically flat and thin in their overall shape and perform very specific functions in human movement.]{.underline}]{.mark}** **Although these muscles are often overlooked in training, [[trunk rotation is a primary and absolutely vital movement in tennis.]{.underline}]{.mark}** Training the core area improves lumbar stability and increases the speed of trunk rotation, which leads to improved velocity and control of serves and groundstrokes.
