...
**[[Skilled players have been shown to use two forms of advance information.]{.underline}]{.mark}** First, situational probability information, such as strategic insights based on known preferences of the server. Second the mechanics of the service action.
...
**These players pick up cues well before the racket meets the ball, providing them with more time to plan their serve return. [[The location or height of the ball toss]{.underline}]{.mark} [[and the angle of the racket during its forward swing to impact]{.underline}]{.mark} seem to provide the most information.**
