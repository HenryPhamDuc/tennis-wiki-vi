...
**Chủ đề:** Slice · **Bộ sưu tập:** Thư Viện Hình Ảnh Tennis

---

## 📷 Sơ đồ đầy đủ / Full Diagram

<a href="../../../assets/thu-vien/returning_low_balls_slice_supination_pronation.png" target="_blank">
  <img alt="Trả Bóng Thấp: FH Slice (Supination) & BH Slice (Pronation)" src="../../../assets/thu-vien/returning_low_balls_slice_supination_pronation.png" style="max-width:100%;height:auto;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,0.12)" loading="lazy" />
</a>
