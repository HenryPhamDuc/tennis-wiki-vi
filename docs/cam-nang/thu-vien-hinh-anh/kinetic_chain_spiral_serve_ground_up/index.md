...
<a href="../../../assets/thu-vien/kinetic_chain_spiral_serve_ground_up.png" target="_blank">
  <img alt="Kinetic Chain & Spiral Process Trong Tennis Serve: Build → Load → Unwind → Release" src="../../../assets/thu-vien/kinetic_chain_spiral_serve_ground_up.png" style="max-width:100%;height:auto;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,0.12)" loading="lazy" />
</a>
