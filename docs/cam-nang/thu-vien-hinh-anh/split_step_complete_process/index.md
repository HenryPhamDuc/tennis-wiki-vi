...
<a href="../../../assets/thu-vien/split_step_complete_process.png" target="_blank">
  <img alt="Split Step — Quy Trình Hoàn Chỉnh" src="../../../assets/thu-vien/split_step_complete_process.png" style="max-width:100%;height:auto;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,0.12)" loading="lazy" />
</a>
