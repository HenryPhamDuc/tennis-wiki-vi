...
<a href="../../../assets/thu-vien/knee_biomechanics_serve_process_overview.png" target="_blank">
  <img alt="Cơ Sinh Học Đầu Gối Trong Tennis Serve – Process Overview" src="../../../assets/thu-vien/knee_biomechanics_serve_process_overview.png" style="max-width:100%;height:auto;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,0.12)" loading="lazy" />
</a>
