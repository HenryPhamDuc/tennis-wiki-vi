...
<a href="../../../assets/thu-vien/complete_process_forehand_biomechanics.png" target="_blank">
  <img alt="Quy Trình Hoàn Chỉnh: Cầm Vợt → Điểm Tiếp Xúc → Đường Vung → Xoáy → Quỹ Đạo" src="../../../assets/thu-vien/complete_process_forehand_biomechanics.png" style="max-width:100%;height:auto;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,0.12)" loading="lazy" />
</a>
