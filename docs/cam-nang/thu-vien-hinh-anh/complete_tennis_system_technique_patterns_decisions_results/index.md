...
<a href="../../../assets/thu-vien/complete_tennis_system_technique_patterns_decisions_results.png" target="_blank">
  <img alt="Hệ Thống Tennis Hoàn Chỉnh: Kỹ Thuật → Mẫu → Quyết Định → Kết Quả" src="../../../assets/thu-vien/complete_tennis_system_technique_patterns_decisions_results.png" style="max-width:100%;height:auto;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,0.12)" loading="lazy" />
</a>
