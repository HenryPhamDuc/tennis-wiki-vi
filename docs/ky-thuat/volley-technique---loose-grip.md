...
source: Volley Technique - Loose Grip.md
updated: 2026-06-20
---
...
In [Power Wave Theory](power-wave-theory.md) terms, the volley does not use a full ground-to-racket wave. The wave is short — essentially a wrist/forearm wave only. The front foot plants (the brake) very early, the wave "plummets," and the stored forces redirect the ball.
