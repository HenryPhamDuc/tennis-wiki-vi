...
Elite recovery is where the [Dantian-Mingmen-COG Framework](dantian-mingmen-cog-framework.md) is most visible: players like Federer, Djokovic, and Alcaraz appear to glide back because they redirect kinetic energy rather than absorbing and regenerating it.
...
**1. Absorption (0–0.04s after contact)**
- Arm finishes high; dantian maintains pressure; mingmen still open (lower back still expanded)
- COG is still on the outside foot
- **Do not rush**: pulling back prematurely kills the forward ball momentum and wastes the stored elastic energy

**2. Redirect (first step)**
- Exhale short; dantian rotates abdomen toward center (inward/left for right-hander)
- Mingmen begins to recoil — lower back "draws in" elastically
- COG starts to fall diagonally inward: this is not a conscious step, it is **weight falling**
- Head and eyes shift toward movement direction *immediately after ball leaves strings*

**3. Re-acceleration**
- When COG passes over midpoint between feet, the inside foot contacts the ground
- The player absorbs the COG fall and uses the court's [Ground Reaction Force](ground-reaction-force.md) to re-accelerate
- No large crossover step needed — the COG projection has already done the work

**Signs of correct execution:**
- Feet don't "clop" when braking (no sudden deceleration impact)
- Lower abdomen feels warm and controlled, not thighs burning
- Head stays at nearly constant height throughout — no bobbing
