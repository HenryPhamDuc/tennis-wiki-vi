...
tags:
  ...
  - tennis-3.0
  - framework
source: "Can-Ban\\tfl-tennis-3-0-details.md"
updated: 2026-06-20
---
...
_Tái lập motor map từ cấp 3.0_
...
3. Sau 30 giây, tự chấm điểm:
   * 10 điểm: Bạn quên mất mình đang đứng → cơ thể ở trạng thái tự nhiên.
   * 7–9 điểm: Có vài điểm căng (thường ở vai, cổ, hoặc tay cầm vợt) — cần tinh chỉnh.
...
2. Xem lại và đánh dấu:
   * Vai có bị nâng lên không?
   * Lưng có bị cong/quá thẳng không?
   * Đầu gối có hướng vào trong (valgus) không?
   * Vợt có bị kéo về phía sau không?
3. So sánh với ảnh tham chiếu của vận động viên chuyên nghiệp ở ready position.
...
_Tại sao đánh nhiều mà không lên trình_
...
_Reactive Perception-Movement — hệ thống xuyên suốt tài liệu_
...
2. Học viên phải thực hiện theo thứ tự:
   ...
   * R: Khi bóng rời tay HLV, học viên chỉ quan sát, không di chuyển gì cả. Cổ vợt giữ nguyên.
   * P: Khi bóng đến giữa lưới, học viên chỉ căn chỉnh trục (xoay vai, hạ trọng tâm), vẫn không di chuyển.
   * M: Khi bóng sắp chạm đất, học viên mới di chuyển + đánh.

3. Lặp lại 15 quả, sau đó tăng tốc độ ném bóng lên dần.
...
_Nguyên lý nội gia ứng dụng vào tennis_
...
_Visual perception và dự đoán quỹ đạo_
...
_Timing, loading và neurological readiness_
...
_Kinematic cues và anticipation training_
...
2. Xem lại ở tốc độ chậm 0.25x và đánh dấu:
   * Unit turn của đối thủ ở cú nào?
   * Front foot position ở cú nào?
   * Eye gaze của đối thủ trước cú đánh?
3. Ghi chép: đối thủ có "tell" (manh mối) gì đặc trưng? Họ luôn xoay vai kiểu nào trước cross-court?
...
_Duy trì đọc bóng khi cognitive load cao_
...
1. Trước khi bắt đầu điểm quan trọng, thực hiện Box Breathing 4-4-4-4:
   ...
   * Thở ra 4 giây
   * Giữ 4 giây
2. Lặp lại 3-4 lần (~1 phút).
3. Kỹ thuật này kích hoạt hệ thần kinh phó giao cảm, giảm nhịp tim, tăng khả năng tập trung.
4. Áp dụng: trước khi nhận serve quan trọng, trước break point, trước match point.
...
_Mượn lực từ mặt đất — nền tảng của mọi cú đánh_
...
2. Explosion phase (pha bùng nổ): Bạn đẩy mạnh chân xuống đất. Mặt đất phản hồi lực đi lên qua:
   ...
   * Xương chày (tibia) → Xương đùi (femur) → Khung chậu (pelvis) → Cột sống → Vai → Cánh tay → Vợt.

3. Sequential transfer (truyền tuần tự): Lực không truyền đồng thời mà truyền theo trình tự với độ trễ rất nhỏ (~10–30ms giữa các khớp) để tạo hiệu ứng "roi da" (whip effect).
...
_Dòng chảy năng lượng từ gót chân đến ngón tay_
...
2. Trong khi thực hiện, gọi tên từng khớp theo thứ tự:
   ...
   * "Cổ tay quấn"
   * "Ngón tay siết"
3. Mục tiêu: thời gian giữa các khớp phải đều và có thể dự đoán được.
4. Khi đã "thuộc" ở tốc độ chậm, tăng dần lên 50%, 75%, 100%.
...
_Xoắn đa chiều thay vì chuyển động ngang tuyến tính_
...
_Power thật sự đến từ elastic release, không từ gồng cơ_
...
2. Trong khi vung, đếm từ 1 đến 5 theo từng giai đoạn:
   * "1 — Hông xoay" (cơ thể bắt đầu, vai/tay thả lỏng)
   * "2 — Vai mở" (vẫn thả lỏng, không dẫn đầu)
   * "3 — Khuỷu duỗi" (cổ tay vẫn mềm)
   * "4 — Cổ tay quấn" (chỉ siết ở cuối)
   * "5 — Tiếp xúc" (bùng nổ)
3. Mục tiêu: ở mỗi giai đoạn "1–4", cổ tay và vai phải hoàn toàn thả lỏng. Chỉ siết ở giai đoạn "5".
4. Lặp lại 20 lần, tăng tốc độ dần.
...
3. So sánh:
   * Gồng cơ: có cảm giác "mạnh" nhưng số quả vào sân thường ít hơn.
   * Thả lỏng: có cảm giác "yếu" nhưng số quả vào sân và chất lượng bóng thường cao hơn.
4. Đây là bằng chứng thực nghiệm cho thấy elastic release hiệu quả hơn gồng cơ.
...
_Ready, Read, React, Respond, Recover_
...
2. Học viên gọi tên từng giai đoạn khi thực hiện:
   * "R1" (sẵn sàng) → đứng ready position.
   * "R2" (đọc) → mắt bắt đầu quét, không di chuyển.
   * "R3" (phản xạ) → split step, chân bắt đầu di chuyển.
   * "R4" (hành động) → di chuyển + đánh.
   * "R5" (hồi phục) → trở về vị trí sẵn sàng.
3. Mục tiêu: 5 giai đoạn phải rõ ràng, không chồng lấn ở giai đoạn đầu.
4. Tăng tốc độ bóng dần — các giai đoạn sẽ bắt đầu chồng lấn tự nhiên.
...
3. Phân tích:
   * R1 có rõ ràng không? Học viên có thực sự "sẵn sàng" trước mỗi cú?
   * R2 có đủ lâu không? Hay họ "bỏ qua" giai đoạn đọc?
   * R3 có kịp thời không? Split step đúng lúc?
   * R4 có mượt không? Có bị "đứt" ở khớp nào?
   * R5 có triệt để không? Học viên trở về vị trí nhanh chóng?
4. Xác định giai đoạn yếu nhất → tập trung sửa trong 1 tuần.
...
2. HLV đánh bóng vào các vị trí khác nhau — học viên phải:
   * R1: Đứng ready ở baseline.
   * R2: Đọc hướng bóng.
   * R3: Split step và phản xạ hướng di chuyển.
   * R4: Di chuyển (có thể cần tránh vật cản) + đánh.
   * R5: Trở về baseline bằng đường tối ưu nhất.
3. Mục tiêu: hoàn thành 5R trong mỗi cú, với thời gian hợp lý.
...
2. Các kiểu bước chân qua thang:
   * In-in-out-out: 2 chân vào 1 ô, 2 chân ra 2 ô liên tiếp.
   * Lateral shuffle: Trượt ngang qua thang (chân không vượt nhau).
   * Carioca (cross-over): Chân trước bước qua chân sau và ngược lại.
3. Mục tiêu: thực hiện 3 vòng thang ở 3 kiểu bước khác nhau, tổng cộng 9 vòng.
4. Tập trung vào mũi chân tiếp đất trước và trọng lượng thấp.
...
_Lựa chọn tư thế theo quỹ đạo bóng và áp lực thời gian_
...
_Di chuyển né trái đánh phải — vũ khí tấn công từ cánh trái_
...
| ---------------------------------- | --------------- | ---------------------------------------------------------- |
| Bóng vào giữa sân, không quá sâu   | Có              | Bạn có thời gian di chuyển, forehand sẽ tạo áp lực lớn hơn |
| Bóng vào cánh trái (forehand), sâu | Không           | Không đủ thời gian, nên đánh backhand                      |
| Bóng cao (ngang vai trở lên)       | Có              | Bạn có thời gian chuẩn bị, forehand sẽ rất mạnh            |
| Bóng sát chân, thấp                | Không           | Khó di chuyển, nên đánh backhand                           |
| Đối thủ đứng ở vị trí yếu          | Có              | Tận dụng cơ hội tấn công                                   |
...
1. Đặt 3 cọc theo hình chữ T:
   * Cọc 1: vị trí ban đầu (forehand side).
   * Cọc 2: vị trí chạm bóng (backhand side, cách cọc 1 khoảng 2m).
   * Cọc 3: vị trí recovery (sau khi đánh, trở về giữa sân).
2. Học viên đứng ở cọc 1, khi HLV vỗ tay → chạy đến cọc 2 (giả lập đánh forehand) → chạy đến cọc 3.
3. Constraint: Phải hoàn thành trong 1.5 giây.
4. Lặp lại 15 lần, đo thời gian → cải thiện dần.
...
2. Học viên phải điều chỉnh kỹ thuật run-around:
   * Bóng gần baseline: run-around + open stance power forehand.
   * Bóng giữa sân: run-around + approach shot (bóng tiến lên lưới).
   * Bóng gần lưới: run-around + volley.
3. Mục tiêu: thành thạo run-around ở mọi tình huống.
...
_Tạo lực khi bị đẩy lùi sau baseline_
...
_3 pattern chủ lực và cách luyện tập theo xác suất_
...
* Cách thực hiện:
  1. Đánh 2–3 cú forehand cross-court sâu, buộc đối thủ di chuyển sang trái.
  2. Khi đối thủ đã di chuyển, đổi sang down-the-line forehand vào góc phải.
  3. Đối thủ phải chạy ngược lại → cú đánh khó hơn, xác suất lỗi cao.
...
* Cách thực hiện:
  1. Đánh slice backhand thấp và sâu, buộc đối thủ phải đánh bóng lên.
  2. Khi đối thủ trả bóng lên (thường là bóng yếu), bạn approach shot (đánh bóng tiến lên lưới).
  3. Tiến lên lưới ngay sau cú approach, volley kết thúc điểm.
...
* Cách thực hiện:
  1. Serve vào ô yếu của đối thủ (thường là body serve hoặc wide serve).
  2. Ngay sau serve, di chuyển đến vị trí forehand (có thể dùng serve-and-volley hoặc serve-and-stay-baseline).
  3. Đối thủ trả bóng yếu → bạn kết thúc bằng forehand winner.
...
_Lọc nhiễu tư duy khi thi đấu áp lực cao_
...
1. Chọn 3 cue words cho 3 tình huống:
   * Trước cú đánh: "Thả lỏng!"
   * Khi cần bóng sâu: "Sâu!"
   * Khi cần approach: "Net!"
2. HLV đánh bóng ngẫu nhiên, học viên sử dụng cue word trước mỗi cú.
3. Lặp lại 30 cú, mục tiêu: sử dụng đúng cue word cho đúng tình huống.
...
_Micro-chunking, video feedback và chu kỳ tiến bộ bền vững_
...
2. Video feedback (phản hồi bằng video):
...
1. Tạo một bảng tự đánh giá với 5 mức độ cho mỗi kỹ năng:
   ...
   * 2: Thực hiện được nhưng không ổn định
   * 3: Thực hiện ổn định ở tốc độ chậm
   * 4: Thực hiện ổn định ở tốc độ trung bình
   * 5: Thực hiện ổn định ở tốc độ cao, dưới áp lực
2. Mỗi tháng, tự đánh giá các kỹ năng trong RPM (R, P, M) và 5R (R1–R5).
3. So sánh qua các tháng để thấy tiến bộ.
...
3. Ghi chép:
   * Điểm nào đã cải thiện rõ rệt?
   * Điểm nào vẫn giậm chân tại chỗ?
   * Điểm nào mới phát hiện cần cải thiện?
4. Đặt micro-goals cho tháng tiếp theo dựa trên phân tích.
...
Tháng 1: Chương 1–4 (Nền tảng) + Chương 20 (Hệ thống tự huấn luyện) Tháng 2: Chương 5–8 (Pha R) + Chương 6 (Split step) tích hợp Tháng 3: Chương 9–12 (Pha P) + Chương 11 (Spiral) tích hợp Tháng 4: Chương 13–17 (Pha M) + Chương 14–15 (Footwork) tích hợp Tháng 5+: Chương 18–19 (Tích hợp) + ôn lại toàn bộ RPM
Lời cuối:
---------
