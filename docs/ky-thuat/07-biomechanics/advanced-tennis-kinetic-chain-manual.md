---
title: "**Advanced Tennis Kinetic‑Chain Manual**"
tags:
  - cẩm-nang
  - ollama
source: "Can-Ban\\advanced-tennis-kinetic-chain-manual.md"
updated: 2026-06-20
---
...
|---|---|---|
| “Cramped” contact (ball near body) | Poor footwork → early load | Practice “step‑into‑contact” drills, force a full‑length stride. |
| “Slap” wrist | Over‑reliance on forearm | Reinforce core & shoulder contribution; decrease wrist torque. |
| “Shoulder drop” at impact | Lack of isometric brace | Add Pallof‑Press + rotation timing work. |
...
- **Patterns:**  
  1. **Wide Serve → Open‑court drive** (attack vacant space).  
  2. **T‑Serve → Inside‑out forehand** (force weak return, punish).  
...
- **Định nghĩa:** Năng lượng động là tổng hợp của ba thành phần:  
  1. **Cơ học (Mechanical Energy)** – lực, công, mô-men tạo ra bởi các khớp.  
  2. **Điện sinh (Electro‑chemical Energy)** – điện thế da, điện thế tế bào cơ (action potential).  
  3. **Siêu âm (Acoustic Energy)** – sóng âm trong mô mềm, giúp truyền năng lượng nhanh hơn so với môi trường cơ học thuần.  
- **Mô hình toán học:**  
  \[
  E_{\text{DET}} = \int_{t_0}^{t_f} \Big[ \underbrace{F(t)\cdot v(t)}_{\text{Cơ học}} + \underbrace{V_{\text{skin}}(t)\cdot I_{\text{skin}}(t)}_{\text{Điện sinh}} + \underbrace{p(t)\cdot A(t)}_{\text{Sóng âm}} \Big] dt
  \]  
  Trong đó:  
